...
router.get("/", auth, async (req, res) => {
  try {
    const user = await User.findById(req.user.id).populate("pendingRequests", "name profilePicture profileImageFocus bannerImageFocus course year enrollmentNumber workProfile");
